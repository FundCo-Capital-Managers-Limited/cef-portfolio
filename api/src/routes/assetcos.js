...
const { list, getOne, create, update, changeStage, regenerateSecret, runReconciliation } = require('../controllers/assetcosController');
...
router.post('/:id/reconciliation/run', runReconciliation);
